...
class NotCORSHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            ...
            elif target == "/joingame" and ("char" in argmap) and is_int(argmap["char"]) and is_valid_character(int(argmap["char"])):
    ...
    def do_POST(self):
        ...
        try:
            ...
            elif target == "/player/leavegame" and ("uid" in argmap) and is_int(argmap["uid"]) and int(argmap["uid"]) in g_players_in_lobby:
                uid = int(argmap["uid"])
